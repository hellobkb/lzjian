...
(function () {
        ...
        initUploader: function () {
            ...
            uploader.on('all', function (type, files) {
                switch (type) {
                    ...
                    case 'startUpload':
                        /* 添加额外的GET参数 */
                        var sdimgcatid = $(window.parent.document).find("#sdimgcatid").val();

                        var params = utils.serializeParam(editor.queryCommandValue('serverparam')) || '',
                            url = utils.formatUrl(actionUrl + (actionUrl.indexOf('?') == -1 ? '?':'&') + 'encode=utf-8&' + params+"&cid="+sdimgcatid+"&cxti="+$(window.parent.document).find("#sdtitlecx").val());
    ...
    /*$('.wrapper').on('click','#srow li',function(){
    ...
    OnlineImage.prototype = {
        ...
        getInsertList: function () {
            var i, lis = $('.row li'), list = [], align = getAlign();
