...
if(file_exists("application/Content/Conf/config.php")){
	$cxurlrule = include "application/Content/Conf/config.php";
}else{
	$cxurlrule= array();
}
...
$configs= array(
        ...
        'MODULE_ALLOW_LIST'  => array('Admin','App','Portal','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay','Cas','Statistics','Contact','Content','Release','Crm','Gadgets','Search','Socialplatform','HelpDocument'),
        ...
        'DEFAULT_FILTER'        =>  'trim,htmlspecialchars,addslashes', // 默认参数过滤方法 用于I函数...htmlspecialchars
        
        'LANG_SWITCH_ON'        =>  true,   // 开启语言包功能
        'DEFAULT_LANG'          =>  'en-us', // 默认语言
        'LANG_LIST'				=>  'zh-cn,en-us,fg-fh,dutch',
        ...
        'SESSION_OPTIONS'       =>  array('expire'=>36000,'path'=>SITE_PATH.'tmp'), // 配置session过期时间

        'PAGE_LISTROWS'         => 20,//分页默认
...
$crm_file_type = array("CRM_FILE_TYPE"=>array("报价","合同","图片","产品图纸","包装","其他文件"));

return  array_merge($configs,$db,$runtime_config, $cxurlrule , $crm_file_type);
