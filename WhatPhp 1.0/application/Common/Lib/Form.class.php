    ...
    public static function editor($textareaid = 'content', $toolbar = 'basic', $module = '', $catid = '', $allowupload = 0, $allowbrowser = 1, $alowuploadexts = '', $allowuploadnum = '10', $height = 200, $disabled_page = 0) {
        ...
        if (!defined('EDITOR_INIT')) {
            $str .= '
                ...
                <script type="text/javascript"  src="' . CONFIG_SITEURL_MODEL . 'statics/js/ueditor/ueditor.config.js"></script>
                <script type="text/javascript"  src="' . CONFIG_SITEURL_MODEL . 'statics/js/ueditor/ueditor.all.min.js"></script>';
