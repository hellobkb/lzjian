...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('contentshow/new_product');?>">推荐产品</a></li>
		</ul>
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if($info): if(is_array($info)): foreach($info as $key=>$vo): ?><tr>
					...
					<td>
						...
						<a href="<?php echo U('Contentshow/recommendajax',array('catid'=>$vo['catid'],'id'=>$vo['id'],'recommend'=>1));?>" class="js-ajax-delete">取消推荐</a>
					</td>
